...
json_file = open('/Users/mayuragarwal/Downloads/model333.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights('/Users/mayuragarwal/Downloads/model333.h5')
loaded_model.compile(loss=categorical_crossentropy,
                     optimizer=Adam(learning_rate=0.001),
                     metrics=['accuracy'])
face_classifier = cv2.CascadeClassifier('/Users/mayuragarwal/Downloads/haarcascade_frontalface_alt.xml')
